...
CREATE TABLE `FriendsWith` (
  ...
  CONSTRAINT `FriendsWith_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `utilisateur` (`id_user`),
  CONSTRAINT `FriendsWith_ibfk_2` FOREIGN KEY (`id_user_1`) REFERENCES `utilisateur` (`id_user`)
...
CREATE TABLE `games` (
  ...
  CONSTRAINT `games_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `utilisateur` (`id_user`),
  CONSTRAINT `games_ibfk_2` FOREIGN KEY (`id_user_1`) REFERENCES `utilisateur` (`id_user`),
  CONSTRAINT `games_ibfk_3` FOREIGN KEY (`id_user_2`) REFERENCES `utilisateur` (`id_user`)
...
CREATE TABLE `utilisateur` (
  ...
  CONSTRAINT `utilisateur_ibfk_1` FOREIGN KEY (`id_grade`) REFERENCES `grade` (`id_grade`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `utilisateur` (`id_user`, `user_name`, `user_password`, `user_score`, `user_total_game`, `user_total_win`, `user_level`, `id_grade`) VALUES (1, '$2y$10$RnzeUqJRYdPYon6pSJ3THeX3fb7AL6oGP4NN6Bb2eUQV.xgq7pTG.', 'jynl', 1, 80, 527, 7, 1);
